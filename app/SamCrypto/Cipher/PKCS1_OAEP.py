...
As an example, a sender may encrypt a message in this way:
        ...
        >>> from SamCrypto.Cipher import PKCS1_OAEP
        >>> from SamCrypto.PublicKey import RSA
        >>>
...
import SamCrypto.Signature.PKCS1_PSS
import SamCrypto.Hash.SHA

from SamCrypto.Util.py3compat import *
import SamCrypto.Util.number
from   SamCrypto.Util.number import ceil_div
from   SamCrypto.Util.strxor import strxor
...
class PKCS1OAEP_Cipher:
    ...
    def __init__(self, key, hashAlgo, mgfunc, label):
        ...
        if hashAlgo:
            ...
            self._hashObj = SamCrypto.Hash.SHA

        if mgfunc:
            self._mgf = mgfunc
        else:
            self._mgf = lambda x,y: SamCrypto.Signature.PKCS1_PSS.MGF1(x, y, self._hashObj)
    ...
    def encrypt(self, message):
        ...
        modBits = SamCrypto.Util.number.size(self._key.n)
